...
def get_base_read_me():
    global base_read_me
    base_read_me += get_count_badge("Solved",total_problems_solved) + get_count_badge("LeetCode",count_leetcode) + get_count_badge("CF",count_cf) + get_count_badge("Cses",count_cses)
    return base_read_me
